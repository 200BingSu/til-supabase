  ...
  return (
    <div className="w-[920px] h-screen bg-[#f9f9f9] border-r border-[#d6d6d6] flex items-start justify-center">
      <div className="w-full flex flex-col p-4">
        <h1 className="w-full text-center text-xl mb-4 font-bold text-slate-700">
          Blog Read
        </h1>
        ...
        <div className="flex justify-end gap-2 mt-4">
          ...
          <Button
            className="cursor-pointer px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600 transition-colors"
            onClick={() => {
              deleteContent();
            }}
          >
