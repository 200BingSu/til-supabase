...
"scripts": {
    ...
    "start": "next start",
    "lint": "next lint",
    "generate-types": "npx supabase gen types typescript --project-id uiptpjnbcstzyxjwijbx --schema public > src/types/types_db.ts"
  },
```

- /src/types/typs_db.ts 생성 확인

## 6. Supabase 활용 관련 파일 생성

- /src/lib 폴더에 기준
- `/src/lib/supabase` 폴더 기준
...
- `/src/middleware.ts`: 파일명이 정해져있음
- 임시로 \_middleware로 파일명 변경
