      ...
      <header className={styles.container_header}>
        <div className={styles.container_header_contents}>
          ...
          <div className={styles.calendarBox}>
            <div className={styles.claendarBox_calendar}>
...
## 1.12. LabelCalendar에 calendar 옵션 처리(보이기, 숨기기)
...
- /src/components/common/BasicBoard.tsx
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-fit min-w-[600px]">
        <DialogHeader>
          ...
          <Separator />
          {/* 마크다운 입력 영역 */}
          <div className={styles.dialog_markdown}>여기에 에디터</div>
...
## 2.2.2. MarkdonwDialog.module.scss
