...
- `/src/components/common/navigation/SideNavigation.tsx` 폴더 생성
- `/src/components/common/navigation/SideNavigation.module.scss` 폴더 생성
